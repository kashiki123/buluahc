            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="birth_weight" name="birth_weight_child" required>
                        <div class="error"></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="birth_height" name="birth_height_child" required>
                        <div class="error"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="place_of_birth" name="place_of_birth_child" rows="3" required></textarea>
...
<script>
    $(document).ready(function () {
        ...
        $('#addPatientButton').click(function () {
            ...
            var birth_weight_child = $('birth_weight').val();
            var birth_height_child = $('birth_height').val();
            var place_of_birth_child = $('place_of_birth').val();
